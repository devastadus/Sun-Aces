...
namespace CircularGravityForce
{
    public class Follow : MonoBehaviour
    {
        ...
        private void MoveObject()
        {
            ...
            Vector3 moveTo = Vector3.Lerp(startPoint, targetPoint, Time.deltaTime * MoveSpeed);
        ...
        private void RotateObject()
        {
            ...
            var newRotation = Quaternion.Slerp(startRotation, lookRotation, Time.deltaTime * RotateSpeed);
